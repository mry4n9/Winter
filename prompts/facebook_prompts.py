...
def get_facebook_prompts_messages(url_context_sum: str, additional_context_sum: str, lead_magnet_sum: str,
    ...
    for stage_name, config in funnel_stages_config.items():
        for i in range(content_count):
            ...
            Task: Generate one Facebook ad variation.
            ...
            Campaign Details:
            - Ad Name: Facebook_{stage_name.replace(" ", "")}_Variation_{i+1}
            ...
            {{
              "Ad Name": "Facebook_{stage_name.replace(" ", "")}_Variation_{i+1}",
              "Funnel Stage": "{stage_name}",
              "Primary Text": "Generated primary text for the ad.",
              "Image Copy": "Suggested text overlay or concept for the ad image/video.",
              "Headline": "Generated headline for the ad (typically shown below image/video).",
              "Link Description": "Generated link description (news feed link description).",
